 ...
 * Entrada: Excepcions
 * Exercici: 3. Hora amb IllegalArgumentException
 */
...
public class E010003HoraTest {
    ...
    @Test
    public void testHoraVàlidaAmbConstructorEspecific() {
    ...
    public static void main(String[] args) {
        JUnitCore.main(new String[]{"E010003HoraTest"});
    }
}
